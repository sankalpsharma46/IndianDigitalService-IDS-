package com.indian.digitalservices.widget.webview;
...
public class WebToAppWebClient extends WebViewClient {
    ...
    public void onPageFinished(WebView view, String url) {
        view.loadUrl("javascript:(function() { " +
                "var head = document.getElementsByClassName('mkd-mobile-header-holder')[0].style.display='none'; " +
                "var head = document.getElementsByClassName('mkd-mobile-header-inner')[0].style.display='none'; " +
                "var head = document.getElementsByClassName('mkd-page-footer')[0].style.display='none'; " +
                "})()");
    }
